...
import { BarChart, Bar, Line, XAxis, YAxis, PieChart, Pie,} from 'recharts'
                ...
                <Grid container justify="center">
                    <Grid item xs={12} md={12} lg={12}>
                        <Paper style={styles.paper}>
                            ...
                            Move Your Fit to wyjątkowa aplikacja, która pomoże osiągnąć Ci sylwetkę, o której marzysz! 
                            </Typography>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={6}>
                        ...
                        <Typography type="headline" component="h3" style={styles.headline}> Odwiedzający </Typography>
                            <BarChart width={350} height={240} data={data} style={styles.chart}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={6}>
                        <Paper style={styles.stats}>
                            ...
                            <PieChart width={350} height={240} style={styles.chart}>
